...
Demo is available at: http://www.textangular.com (Or editable [Plunkr Demo](http://plnkr.co/edit/hz3x2f?p=preview))aaas

#### Upgrading From 1.2.2 or earliers a
...
3. `Font-Awesome` ≥ `4.x` for the default icons on the toolbars
